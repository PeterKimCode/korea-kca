...
const courseTagMap = {
  "펫푸드스타일리스트 1급": ["돌봄", "반려동물","국제"],
  "병원상담사": ["상담", "의료서비스","국제"],
  "커피바리스타전문가 1급": ["문화", "식음료","국제"],
  "건강관리사": ["돌봄", "건강","국제"],
  "간병사": ["돌봄", "복지","국제"],
  "심리상담사 1급": ["상담", "심리","국제"],
  "방과후지도사": ["문화", "아동교육","국제"],
  "노인교육지도사": ["돌봄", "시니어","국제"],
  "반려동물관리사 1급": ["돌봄", "반려동물","국제"],
  "유기농 식품관리전문가 1급": ["안전", "식품","국제"],
  "가족문화상담사 1급": ["상담", "가족","국제"],
  "정리수납전문가": ["문화", "생활","국제"],
  "문해교육지도사": ["문화", "교육","국제"],
  "감정코칭지도사": ["상담", "정서","국제"],
  ...
  "아동요리지도사": ["문화", "아동교육","국제"],
  "독서지도사 1급": ["문화", "아동교육","국제"],
  "챗GPT활용가 1급": ["디지털", "AI","국제"],
  "인공지능(AI)전문가 1급": ["디지털", "AI","국제"],
  "광고기획전문가 1급": ["디지털", "마케팅","국제"],
  "SNS마케팅전문가": ["디지털", "마케팅","국제"],
  "문서실무전문가": ["디지털", "오피스","국제"],
  "CS강사 1급": ["상담", "고객응대","국제"],
  "진로코칭지도사": ["상담", "커리어","국제"],
  "한국문화전문가 1급": ["문화", "교육","국제"],
  "컴퓨터활용가 1급": ["디지털", "업무자동화","국제"],
  "커리어상담가 1급": ["상담", "진로","국제"],
  "명상지도사 1급": ["상담", "마음건강","국제"],
  "안전교육지도사": ["안전", "교육","국제"],
  "학교폭력예방상담사": ["상담", "청소년","국제"],
